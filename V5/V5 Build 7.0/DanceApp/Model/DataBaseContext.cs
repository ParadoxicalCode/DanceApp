    ...
    public class DataBaseContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Competition>().HasData(
                new Competition { ID = 1, Title = "Зимний бал", StartDate = "2023.21.05", StartTime = "18:00", Manager = "Печурин Р.К.", Address = "ул. Максима Горького, д.16", RegistrationSwitch = true, UpdateGroups = true }
            );
